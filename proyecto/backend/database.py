...
def init_db():
    ...
    from proyecto.backend.Entity.usuario import Base as UsuarioBase
    from proyecto.backend.Entity.producto import Base as ProductoBase
    from proyecto.backend.Entity.movimiento import Base as MovimientoBase
    from proyecto.backend.Entity.proveedor import Base as ProveedorBase
    from proyecto.backend.Entity.categoria import Base as CategoriaBase
